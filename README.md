The surface reflectance project contains application source code for producing surface reflectance products.  It currently consists of LEDAPS for Landsats 4-7 and LaSRC for Landsat 8-9 and Sentinel-2.
